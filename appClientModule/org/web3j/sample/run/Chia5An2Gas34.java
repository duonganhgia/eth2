...
public class Chia5An2Gas34 implements Runnable {
    private static final Logger log = LoggerFactory.getLogger(Chia5An2Gas34.class);

    @Override
    public void run() {
        Logger log = LoggerFactory.getLogger(Chia5An2Gas34.class);
